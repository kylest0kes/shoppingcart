        ...
        <div className="about-container">
            <div className="marketing-site-content-section">
                ...
                <div className="marketing-site-content-section-block">
                    ...
                    <h5 className="project-desc">PushCart is a shopping cart application built with React and Redux. You are able to add items from the store into your cart, which then will display your items in the cart, their info, and a summary of how many items, and the total cost of your cart. The application also makes use of local state to persist the cart items on reload.</h5>
